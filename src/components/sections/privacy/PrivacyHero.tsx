// src/components/sections/privacy/PrivacyHero.tsx
"use client";

import { motion } from "framer-motion";

/**
 * Hero section for Privacy page - full screen with animated background
 */
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white pt-16 hero-section">
      ...
      <div className="absolute inset-0 opacity-20">
        <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="privacy-hero" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
          ...
          <rect width="100%" height="100%" fill="url(#privacy-hero)" />
        </svg>

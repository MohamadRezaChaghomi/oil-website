      ...
      <div className="container mx-auto px-4">
        ...
        <div className="hidden md:block relative group">
          ...
          <div
            ...
            className="flex overflow-x-auto gap-6 pb-8 scroll-smooth snap-x snap-mandatory"
        ...
        {/* راهنمای اسکرول */}
        <div className="hidden md:block text-center mt-8 text-sm text-muted-foreground">
          ← → برای دیدن بقیه، افقی اسکرول کنید
        </div>
      </div>
    </section>
  );

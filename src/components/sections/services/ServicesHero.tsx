 ...
 * Full-screen with animated background and gradient text
 */
export function ServicesHero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white pt-16 hero-section">
      {/* Animated background pattern - pipelines and droplets */}
      <div className="absolute inset-0 opacity-20">
        <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="services-hero" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
          ...
          <rect width="100%" height="100%" fill="url(#services-hero)" />
        </svg>
        <motion.div
      ...
      <div className="container mx-auto px-4 py-20 text-center relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            راه‌حل‌های جامع متناسب با نیازهای در حال تحول صنعت انرژی جهانی.
            از اکتشاف تا تحویل، ما شریک قابل اعتماد شما هستیم.
          </p>
        </motion.div>

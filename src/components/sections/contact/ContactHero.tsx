    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white pt-16 hero-section">
      ...
      <div className="absolute inset-0 opacity-20">
        <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="contact-hero-pattern" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
      ...
      <div className="container mx-auto px-4 py-20 text-center relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            سوالی دارید؟ ما اینجا هستیم تا کمک کنیم. با تیم ما تماس بگیرید، در اسرع وقت پاسخ خواهیم داد.
          </p>
        </motion.div>
